...
cp ../agents ../workspace-pack.py ../usage.py ../vendors.sh ../fleet.sh ../fleet-sync.sh ../fleet-exec.sh ../fleet-qa-import.py ../fleet-manifest.py "$bin_dir/n2-loop" "$app/Contents/Resources/"
