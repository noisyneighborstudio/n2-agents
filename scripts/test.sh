...
print -r -- "$porcelain" | grep -q '^V	claude	1	instance	oauth	Claude Code	projects	CC	Claude Desktop	com.anthropic.claudefordesktop$'
print -r -- "$porcelain" | grep -q '^V	codex	1	instance	oauth	Codex	sessions	CX	Codex	com.openai.codex$'
